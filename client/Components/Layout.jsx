...
import { Brain, Database, RefreshCw, MessageCircle, Menu, X } from 'lucide-react';
...
const Layout = ({ children, personas = [], loading = false, error = null, onRefresh, onNavigate }) => {
	...
	return (
		<div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
			...
			{/* Header */}
			<header className="relative z-20 bg-slate-900/90 backdrop-blur-sm border-b border-slate-700/50 sticky top-0">
				<div className="w-full px-4 sm:px-6 py-3 sm:py-4">
					<div className="flex items-center justify-between">
						...
						<div className="flex items-center gap-2 sm:gap-3">
							...
							<h1 className="text-lg sm:text-2xl font-bold bg-gradient-to-r from-cyan-300 to-blue-300 bg-clip-text text-transparent">
								{APP_NAME}
							</h1>
						</div>
						...
						<div className="flex items-center gap-2 sm:gap-4">
							{/* Database Status & Refresh - Desktop */}
							...
							{/* User Actions */}
							<div className="flex items-center gap-2 sm:gap-3">
								<button className="hidden sm:block px-3 sm:px-4 py-2 text-slate-300 hover:text-white transition-colors font-medium text-sm">
									Sign In
								</button>
								<button 
									onClick={() => onNavigate && onNavigate('/chat/sachin')}
									className="bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-700 hover:to-blue-700 text-white font-semibold px-3 sm:px-6 py-2 rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:shadow-cyan-500/25 text-sm sm:text-base"
								>
									Start Learning
								</button>
							</div>
				...
				{/* Mobile Menu Overlay */}
				<div 
					className={`md:hidden absolute top-full left-0 right-0 bg-slate-900/95 backdrop-blur-sm border-b border-slate-700/50 z-30 transition-all duration-300 ease-in-out ${
						isMobileMenuOpen 
				...
				>
					<nav className="px-4 py-6 space-y-4">
						<a 
							...
							className="block text-slate-300 hover:text-cyan-400 transition-colors font-medium py-2 border-b border-slate-700/30 hover:bg-slate-800/30 rounded-lg px-2"
						>
							Home
						</a>
						<a 
						...
						<div className="pt-4">
							<button 
								onClick={() => {
									closeMobileMenu();
									onNavigate && onNavigate('/chat/sachin');
								}}
								className="w-full bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-700 hover:to-blue-700 text-white font-semibold px-6 py-3 rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:shadow-cyan-500/25 active:scale-95"
							>
								Start Learning
							</button>
						</div>
					...
					<div className="grid grid-cols-1 md:grid-cols-4 gap-6 sm:gap-8 mb-6 sm:mb-8">
						...
						<div className="col-span-1 md:col-span-2">
							<div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
								...
								<h4 className="text-lg sm:text-xl font-bold bg-gradient-to-r from-cyan-300 to-blue-300 bg-clip-text text-transparent">
									SachinAI
								</h4>
							</div>
							...
							<div className="flex items-center gap-3 sm:gap-4">
								...
								<span className="text-slate-400 text-xs sm:text-sm">Live AI Mentors Available</span>
							</div>
						</div>

						{/* Quick Links */}
						<div>
							<h5 className="text-white font-semibold mb-3 sm:mb-4 text-sm sm:text-base">Quick Links</h5>
							<ul className="space-y-1.5 sm:space-y-2">
								<li><a href="/" className="text-slate-400 hover:text-cyan-400 transition-colors text-sm">Home</a></li>
								<li><a href="#" className="text-slate-400 hover:text-cyan-400 transition-colors text-sm">Mentors</a></li>
								<li><a href="#" className="text-slate-400 hover:text-cyan-400 transition-colors text-sm">Technologies</a></li>
						...
						{/* Support */}
						<div>
							<h5 className="text-white font-semibold mb-3 sm:mb-4 text-sm sm:text-base">Support</h5>
							<ul className="space-y-1.5 sm:space-y-2">
								<li><a href="#" className="text-slate-400 hover:text-cyan-400 transition-colors text-sm">Help Center</a></li>
								<li><a href="#" className="text-slate-400 hover:text-cyan-400 transition-colors text-sm">Contact Us</a></li>
								<li><a href="#" className="text-slate-400 hover:text-cyan-400 transition-colors text-sm">FAQ</a></li>
								<li><a href="#" className="text-slate-400 hover:text-cyan-400 transition-colors text-sm">Community</a></li>
							</ul>
						</div>
					</div>
